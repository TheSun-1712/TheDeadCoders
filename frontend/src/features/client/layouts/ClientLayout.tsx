...
const Layout = ({ children }: { children: React.ReactNode }) => {
    ...
    return (
        <div className="client-portal flex h-screen bg-black text-slate-100 font-display selection:bg-orange-500/40 selection:text-white">
            {/* Sidebar */}
            <aside className="w-64 bg-zinc-950 border-r border-zinc-800 flex flex-col z-20 hidden md:flex">
                ...
                <div className="p-4 border-t border-slate-800">
                    <div className="flex items-center gap-3 p-2 rounded-lg hover:bg-surface-dark transition-colors cursor-pointer">
                        <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-orange-500 to-orange-300 flex items-center justify-center text-white text-xs font-bold">
                            AU
                        </div>
            ...
            <main className="flex-1 flex flex-col h-full overflow-hidden relative">
                ...
                <header className="h-16 bg-surface-darker border-b border-slate-800 flex items-center justify-between px-6 z-10">
                    <div className="flex items-center gap-4">
                        <div className="relative hidden sm:block">
                            ...
                            <input
                                ...
                                className="pl-8 pr-4 py-1.5 text-sm bg-zinc-900 border-none rounded text-slate-200 placeholder-slate-400 focus:ring-1 focus:ring-orange-500 w-64"
                            />
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <button className="relative p-2 text-slate-300 hover:text-orange-300 transition-colors">
